...
\newcommand{\urldocspypsg}{\url{https://tedjohnson12.github.io/pypsg/}}
...
The flow of \vspec{}'s code is broken into three parts: i) read in the configuration, ii) compute planetary spectra, and iii) compute stellar spectra. Detailed API documentation, configuration parameter descriptions, and examples can be found on the \vspec{} documentation page\footnote{\urldocsvspec}.
