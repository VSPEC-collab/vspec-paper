...
A powerful feature of \texttt{libpypsg} is that it provides a universal interface for 3D atmosphere models and PSG's Global Emission Spectra (GlobES) application \TJ{(Fauchez et al., 2024, in review; see also Kofman et al., 2024, accepted)}.
...
T.J. acknowledges support from the Exoplanet Modeling and Analysis Center \citep[EMAC, ][]{renaud2023}.
