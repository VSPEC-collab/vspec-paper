...
\author[3]{Ashraf Dhahbi\,\orcidlink{0009-0009-0200-6821}}

\author[3]{Tobi Hammond\,\orcidlink{0009-0002-5756-9778}}

\author[3]{Thomas Barclay\,\orcidlink{0000-0001-7139-2724}}
...
It should be noted that varying temperature in the z direction via Equation (\ref{eq:tz}) violates one of the assumptions of the \citet{cowan2011} prescription -- that the gas parcel modeled is several scale heights thick. It also does not allow for heat exchange between atmosphere layers, which could have significant impacts on the atmosphere's energy balance.
