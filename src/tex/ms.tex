...
\vspec{} allows users to run models with any climate model they desire (so long as it can be converted into the \texttt{pypsg.PyGCM} format) and even comes with utilities to work with PSG/GlobES binary files, ExoCAM \citep{wolf2022}, the Whole Atmosphere Community Climate Model \citep[WACCM,][]{marsh2013}, and ExoPlaSim \citep{paradise2022} without any custom code from the user.
